...
export default function HeroVideo(){
  ...
  return (
    <section aria-label="Video principal" className="relative bg-black">
      <video ref={vidRef} className="w-full h-[70vh] sm:h-[80vh] object-cover"
             poster="/assets/hero-poster.jpg" playsInline muted loop preload="metadata" controls={false}>
        <source src="/assets/hero.mp4" type="video/mp4" />
        Tu navegador no soporta video HTML5.
      </video>
      {/* Botones glass abajo-derecha, lado a lado, texto negro */}
